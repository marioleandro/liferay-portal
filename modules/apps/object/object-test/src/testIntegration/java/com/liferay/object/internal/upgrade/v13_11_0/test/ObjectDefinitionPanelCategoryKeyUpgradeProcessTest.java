...
package com.liferay.object.internal.upgrade.v13_11_0.test;
...
public class ObjectDefinitionPanelCategoryKeyUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		...
		_renamedObjectDefinition = _addObjectDefinition(
		...
		for (UpgradeProcess upgradeProcess :
				UpgradeTestUtil.getUpgradeSteps(
					_upgradeStepRegistrator, new Version(13, 11, 0))) {
		...
		Assert.assertEquals(
			...
			_getPanelCategoryKey(_renamedObjectDefinition));
		Assert.assertEquals(
			PanelCategoryKeys.CONTROL_PANEL_WORKFLOW,
	...
	@DeleteAfterTestRun
	private ObjectDefinition _renamedObjectDefinition;
