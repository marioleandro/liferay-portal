...
public class SideNavigationDisplayContext {
	...
	private List<String> _getExpandedKeys() {
		...
		for (PanelCategory childPanelCategory : _getRootChildPanelCategories()) {
	...
	private List<Map<String, Object>> _getPropsItems() throws Exception {
		...
		List<PanelCategory> childPanelCategories = _getRootChildPanelCategories();
		...
		for (PanelCategory childPanelCategory : childPanelCategories) {
			...
			lastScope = childPanelCategoryScope;
		}
		...
		for (PanelCategory childPanelCategory : childPanelCategories) {
			...
			Map<String, Object> panelCategoryPropsItem =
				_getPanelCategoryPropsItem(childPanelCategory, lastScope);
